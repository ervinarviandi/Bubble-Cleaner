        ...
        <div className="grid md:grid-cols-3 gap-5">
          <div className="flex flex-col">
            <div className="bg-gray-200 hover:bg-gray-100 rounded-lg p-4 cursor-pointer ">
              ...
              <p className="font-poppins text-lg text-center">Treatment pencucian untuk menghilangkan noda dan aman untuk semua bahan. secara cepat</p>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="hover:bg-gray-100 bg-gray-200 rounded-lg p-4 cursor-pointer">
              ...
              <p className="font-poppins text-lg text-center">Treatment pewarnaan ulang/penggantian warna untuk mencerahkan kembali warna sepatu anda.</p>
            </div>
          </div>
          <div className="flex flex-col">
            <div className="bg-gray-200 hover:bg-gray-100 rounded-lg p-4 cursor-pointer">
              ...
              <p className="font-poppins text-lg text-center">Live chat, Konsultasikan masalah sepatu, tas kalian langsung pada tim kami.</p>
            </div>
          </div>
        </div>
