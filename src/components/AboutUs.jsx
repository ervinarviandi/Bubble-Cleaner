    ...
    <div className="w-full bg-black " id="about">
      <div className="lg:max-w-6xl mx-auto px-7 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          ...
          <div className="flex flex-col">
            <h2 className="text-3xl text-white font-poppins mt-7 lg:text-left text-center">Shoes and Care</h2>
            <p className="text-lg font-poppins  mt-7 text-gray-300 lg:text-left text-center">
